...
// The AdjacentTableFunc type is an adapter to allow the use of ordinary
// function as AdjacentTable mutator.
type AdjacentTableFunc func(context.Context, *ent.AdjacentTableMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AdjacentTableFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AdjacentTableMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AdjacentTableMutation", m)
	}
	return f(ctx, mv)
}
...
// The InstituteFunc type is an adapter to allow the use of ordinary
// function as Institute mutator.
type InstituteFunc func(context.Context, *ent.InstituteMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f InstituteFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.InstituteMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.InstituteMutation", m)
	}
	return f(ctx, mv)
}
