...
func (aq *AdminQuery) QueryInstitute() *InstituteQuery {
	query := &InstituteQuery{config: aq.config}
...
func (aq *AdminQuery) Clone() *AdminQuery {
	...
	return &AdminQuery{
		...
		withInstitute: aq.withInstitute.Clone(),
...
func (aq *AdminQuery) WithInstitute(opts ...func(*InstituteQuery)) *AdminQuery {
	query := &InstituteQuery{config: aq.config}
	for _, opt := range opts {
		opt(query)
	}
	aq.withInstitute = query
	return aq
}
...
func (aq *AdminQuery) sqlAll(ctx context.Context) ([]*Admin, error) {
	...
	if query := aq.withInstitute; query != nil {
